...
app.get('/sortedDisks', function (req,res) {
    ...
    {
        query= "select Disks.pID,Disks.artist,Disks.name,Disks.cost,Disks.purchaceAmount,Disks.addDate,Disks.publishDate from Disks inner join CategoriesForDisk on Disks.pID=CategoriesForDisk.pID order by Disks."+sortType;
    }
